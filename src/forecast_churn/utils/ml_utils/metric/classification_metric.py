from src.forecast_churn.entity.artifact_entity import ClassificationMetricArtifact
...
def get_classification_score(y_true, y_pred):
    try:
        ...
        classification_metric = ClassificationMetricArtifact(accuracy_score=model_accuracy_score,
